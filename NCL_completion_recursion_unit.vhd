...
begin
    ...
    complete_4 : if width = 4 generate 
        single_gate : entity ncl_gates.TH44 port map (A => vector_input(3), B => vector_input(2), C => vector_input(1), D => vector_input(0), Z => result_output);
    end generate;
        
    complete_3 : if width = 3 generate 
        single_gate : entity ncl_gates.TH33 port map (A => vector_input(2), B => vector_input(1), C => vector_input(0), Z => result_output);
    end generate;
    
    complete_2 : if width = 2 generate 
        single_gate : entity ncl_gates.TH22 port map (A => vector_input(1), B => vector_input(0), Z => result_output);
    end generate;
    ...
    continue_recursion : if (width > 4) generate
        ...
        four_input_gates : for i in (width/4) downto 1 generate
            unit: entity ncl_gates.TH44 port map (   A => vector_input( width-( ((width/4)-i)*4 )-1), 
        ...
        three_input_remainder_gate: if (width mod 4 = 3) generate
            three_input_unit: entity ncl_gates.TH33 port map (  A => vector_input(2), 
                                                                       B => vector_input(1), 
                                                                       C => vector_input(0),
        ...
        two_input_remainder_gate: if (width mod 4 = 2) generate
            two_input_unit: entity ncl_gates.TH22 port map (   A => vector_input(1), 
                                                                       B => vector_input(0),
                                                                       Z => intermediate_signal(0));
        end generate;
        ...
        recursion_with_remainer : if (width mod 4 /= 0) generate    
            recursive_unit: entity ncl_gates.NCL_completion_recursion_unit 
