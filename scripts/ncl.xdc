...
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB0}] -filter "REF_PIN_NAME=~I0"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB0}] -filter "REF_PIN_NAME=~O"]
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB1}] -filter "REF_PIN_NAME=~I1"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB1}] -filter "REF_PIN_NAME=~O"]
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB2}] -filter "REF_PIN_NAME=~I2"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB2}] -filter "REF_PIN_NAME=~O"]
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB3}] -filter "REF_PIN_NAME=~I3"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB3}] -filter "REF_PIN_NAME=~O"]
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB4}] -filter "REF_PIN_NAME=~I4"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB4}] -filter "REF_PIN_NAME=~O"]
set_max_delay 1.1 -to [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB5}] -filter "REF_PIN_NAME=~I5"] -from [get_pins -of_objects [get_cells -hierarchical {NCL_GATE_FB5}] -filter "REF_PIN_NAME=~O"]
